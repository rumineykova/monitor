# $ANTLR 3.1.3 Mar 18, 2009 10:09:25 src/Monitor.g 2011-11-18 22:39:11
...
class MonitorParser(Parser):
    ...
    def recBlockDef(self, ):
        ...
        try:
            try:
                ...
                # AST Rewrite
                # elements: 43, labelName, blockDef
                # token labels: 
                # rule labels: retval
                # token list labels: 
                # rule list labels: 
    ...
    # src/Monitor.g:117:1: unorderedDef : 'unordered' blockDef -> ^( UNORDERED blockDef ) ;
    def unorderedDef(self, ):
        ...
        try:
            try:
                # src/Monitor.g:117:13: ( 'unordered' blockDef -> ^( UNORDERED blockDef ) )
                # src/Monitor.g:117:15: 'unordered' blockDef
                pass 
                string_literal148=self.match(self.input, 51, self.FOLLOW_51_in_unorderedDef1076) 
                if self._state.backtracking == 0:
                    stream_51.add(string_literal148)
                self._state.following.append(self.FOLLOW_blockDef_in_unorderedDef1078)
                ...
                if self._state.backtracking == 0:
                    ...
                    # src/Monitor.g:117:39: ^( UNORDERED blockDef )
                    root_1 = self._adaptor.nil()
    ...
    def expr(self, ):
        ...
        try:
            try:
                ...
                self._state.following.append(self.FOLLOW_term_in_expr1098)
                term150 = self.term()
                ...
                while True: #loop42
                    ...
                    if alt42 == 1:
                        ...
                        self._state.following.append(self.FOLLOW_term_in_expr1113)
                        term152 = self.term()
            ...
            try:
                ...
                while True: #loop43
                    ...
                    if alt43 == 1:
                        ...
                        self._state.following.append(self.FOLLOW_factor_in_term1139)
    ...
    def factor(self, ):
        ...
        try:
            try:
                ...
                NUMBER156=self.match(self.input, NUMBER, self.FOLLOW_NUMBER_in_factor1151)
                if self._state.backtracking == 0:
    ...
    FOLLOW_51_in_unorderedDef1076 = frozenset([31, 32])
    FOLLOW_blockDef_in_unorderedDef1078 = frozenset([1])
    FOLLOW_term_in_expr1098 = frozenset([1, 5, 6])
    FOLLOW_set_in_expr1102 = frozenset([20])
    FOLLOW_term_in_expr1113 = frozenset([1, 5, 6])
    FOLLOW_factor_in_term1125 = frozenset([1, 7, 8])
    FOLLOW_set_in_term1129 = frozenset([20])
    FOLLOW_factor_in_term1139 = frozenset([1, 7, 8])
    FOLLOW_NUMBER_in_factor1151 = frozenset([1])
